...
export default function Service() {
  return (
    <div className='flex md:flex-row flex-col justify-between w-[100%] p-[5%] items-center'>
      ...
      <div className='flex justify-center items-center flex-col gap-2'>
        <svg aria-hidden="true" focusable="false" fill="none" strokeWidth="1.4" width="52" className="hidden sm:block icon icon-picto-customer-support" viewBox="0 0 24 24">
      ...
      <div className='flex justify-center items-center flex-col gap-2'>
        <svg aria-hidden="true" focusable="false" fill="none" strokeWidth="1.4" width="52" className="hidden sm:block icon icon-picto-delivery-truck" viewBox="0 0 24 24">
      ...
      <div className='flex justify-center items-center flex-col gap-2'>
        <svg aria-hidden="true" focusable="false" fill="none" strokeWidth="1.4" width="52" className="hidden sm:block icon icon-picto-return" viewBox="0 0 24 24">
      ...
      <div className='flex justify-center items-center flex-col gap-2'>
        <svg aria-hidden="true" focusable="false" fill="none" strokeWidth="1.4" width="52" className="hidden sm:block icon icon-picto-lock" viewBox="0 0 24 24">
