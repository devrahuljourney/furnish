...
export default function Navbar() {
  ...
  return (
    <div className={`w-full fixed z-10  `}>
      ...
      <div className={`w-[100%] bg-transparent hover:bg-[#F6F0ED]  z-10 flex justify-between items-center py-4 px-[5%] ${prevScrollPos === 0 ? "bg-transparent" : "bg-[#F6F0ED]" }  ${visible ? "top-0  " : " absolute -top-[200px] "  }`}>
        {/* Logo */}
